...
type SMS struct {
	...
	Priority       priority           `json:"priority,omitempty"`        // Default ‘NORMAL’. One of ‘BULK’, ‘NORMAL’, ‘URGENT’ and ‘VERY_URGENT’. Urgent and Very Urgent normally require the use of premium message class.
